...
*/
void WindowGrabber::grabWindowRect ( int screen )
{
  Display* dpy;
  ...
  qDebug ( "qx11grab: grabbing from: \"-i %s+%d,%d -s %dx%d\"",
           dpy->display_name,
           rect.x(),
           rect.y(),
           rect.width(),
...
*/
void WindowGrabber::createRequest ( int screen )
{
...
*/
const QRect WindowGrabber::fullDesktopsRect ()
{
