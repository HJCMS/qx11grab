...
IF (CMAKE_SYSTEM_NAME MATCHES Linux)
  ...
  SET (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wformat-security -Wctor-dtor-privacy -fexceptions")
...
CHECK_CXX_ACCEPTS_FLAG (-fvisibility=hidden __CHECK_GCC_VISIBILITY)
...
CHECK_CXX_ACCEPTS_FLAG (-fstack-protector __CHECK_GCC_STACK_PROTECTOR)
...
# BUFFER CHECKS
CHECK_CXX_ACCEPTS_FLAG (-D_FORTIFY_SOURCE=2 __CHECK_GCC_FORTIFY_SOURCE)
IF(__CHECK_GCC_FORTIFY_SOURCE)
  SET (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -D_FORTIFY_SOURCE=2")
ENDIF(__CHECK_GCC_FORTIFY_SOURCE)

# EMIT POSITION-INDEPENDENT CODE
CHECK_CXX_ACCEPTS_FLAG (-fPIC __CHECK_GCC_FPIC)
IF (__CHECK_GCC_FPIC)
...
CHECK_CXX_ACCEPTS_FLAG (-pie __CHECK_GCC_FPIE)
IF (__CHECK_GCC_FPIE)
...
# Check ISO C++ 2011 Support
CHECK_CXX_ACCEPTS_FLAG (-std=gnu++11 __CHECK_ISO_CPLUSPLUS_2011)
IF (__CHECK_ISO_CPLUSPLUS_2011)
  SET (ISOPP2011_CXXFLAGS "-std=gnu++11")
ELSE (__CHECK_ISO_CPLUSPLUS_2011)
  SET (ISOPP2011_CXXFLAGS "")
ENDIF (__CHECK_ISO_CPLUSPLUS_2011)

# PASS THE FLAG -EXPORT-DYNAMIC TO THE ELF LINKER, ON TARGETS THAT SUPPORT IT.
CHECK_CXX_ACCEPTS_FLAG (-rdynamic __CHECK_LINK_RDYNAMIC)
...
CHECK_CXX_ACCEPTS_FLAG (-funwind-tables __CHECK_GCC_UNWIND_TABLES)
